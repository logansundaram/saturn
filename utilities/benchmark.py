...
"""
  ...
  # Run specific suites
  python benchmark.py --suites llm calculator
  python benchmark.py --suites web_search multi_tool deep_research
"""
...
"""
  python benchmark.py --suites llm --output logging/benchmarks/my_run.json
"""
SUITES: dict[str, list[str]] = {
    ...
    "filesystem": [
        "List the files in the database/documents directory.",
        "Read the file at database/workspace/.manifest.md and summarize it.",
        "Create a file called test_output.txt with the text 'benchmark test'.",
    ],
    "rag": [
        "What documents are available in the knowledge base?",
    ],
    "multi_tool": [
        "Search the web for the latest news on LangGraph and save a summary to database/workspace/langgraph_news.md.",
